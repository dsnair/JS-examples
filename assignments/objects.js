...
Use the console.log provided as a hint: console.log(kennan.speak());
*/
...
Use the console.log provided as a hint: console.log(antonietta.multiply(3,4));
*/

interns.antonietta.multiply = (num1, num2) => {
  return num1 * num2
}
console.log(interns.antonietta.multiply(3, 4))
