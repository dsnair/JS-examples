...
*/
console.log(
  `Car 33 is a ${inventory.find(car => car.id === 33).car_year} ${
    inventory.find(car => car.id === 33).car_make
  } ${inventory.find(car => car.id === 33).car_model}.`
)
...
console.log(
  `The lot has ${
    inventory.filter(car => car.car_year < 2000).length
  } cars that are older than the year 2000.`
)
